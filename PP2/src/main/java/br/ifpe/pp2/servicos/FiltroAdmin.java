...
public class FiltroAdmin implements Filter{
	private String[] pathsLiberadosTodos = { "/","/finalizar","/confirmarCompra","/removerProd","/addCarrinho","/alterarQtd","/carrinho","/login","/login/usuario","/admin","/entrar/admin","/pesquisarProdutos","/cadastro", "/salvar/novousuario","/foto(.*)","/h2-console(.*)" ,"/assets(.*)","/css(.*)", "/js(.*)"};
	private String[] pathsLiberadosLogadoComum  = { "/","/confirmarCompra","/finalizar","/comprando","/removerProd","/finalizar","/confirmarCompra","/addCarrinho","/alterarQtd","/removerConta","/minhaconta","/alterardados","/carrinho","/login","/pesquisarProdutos","/login/usuario","/meuspedidos","/logout","/admin","/entrar/admin", "/cadastro", "/foto(.*)","/h2-console(.*)" ,"/css(.*)", "/js(.*)","/assets(.*)"};
